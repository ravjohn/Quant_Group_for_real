...
```
The correlation for mental health and median age is -0.4883118 and the 95% confidence interval is below zero.
...
```
The correlation for mental health and percent of households using SNAP is 0.6922096, and the 95% confidence interval is above zero.
